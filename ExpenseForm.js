    ...
    <div className={`app ${theme}`}>
      ...
      <div>
        ...
        {isPremium && totalExpenses > 10000 && (
         ...
         {totalExpenses > 10000 && <button className="premium-button">Activate Premium</button>}
      ...
      {user && (
        <div className="export-section">
          <button onClick={downloadExpensesAsCSV}>Export as CSV</button>
        </div>
      )}
    </div>
  );
...
const ExpenseForm = () => {
  ...
  const downloadExpensesAsCSV = () => {
    ...
    if (totalExpenses > 10000) {
      ...
      console.log('Total expenses should be greater than 10000 to export as CSV');
    }
  };
